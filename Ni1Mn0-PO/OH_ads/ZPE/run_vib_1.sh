...
then
    ...
    which pw.x
    echo 'Executing job.....'
    mpirun -np ${NP} pw.x < PWINPUT_atm157_xp> LOG_atm157_xp
    mpirun -np ${NP} pw.x < PWINPUT_atm157_xm> LOG_atm157_xm
    mpirun -np ${NP} pw.x < PWINPUT_atm157_yp> LOG_atm157_yp
    mpirun -np ${NP} pw.x < PWINPUT_atm157_ym> LOG_atm157_ym
    mpirun -np ${NP} pw.x < PWINPUT_atm157_zp> LOG_atm157_zp
    mpirun -np ${NP} pw.x < PWINPUT_atm157_zm> LOG_atm157_zm
    echo 'Done!'
fi
